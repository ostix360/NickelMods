...
public class NickelMLeggings extends ItemArmor
{
    public NickelMLeggings(String name,ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
    {
