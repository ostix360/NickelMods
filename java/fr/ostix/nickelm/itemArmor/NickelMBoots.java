...
public class NickelMBoots extends ItemArmor
{
    public NickelMBoots(String name,ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
    {
